#Script Given By Rashed

#Script Is Given For Educational Purpose

#Script Edited By @rasheddadu
...
\033[1;92mAuthor \033[1;93m: Rashed Dadu

\033[1;92mFb \033[1;93m: https://www.facebook.com/Rashed.innocent.devil
...
def crack():
    ...
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks RASHED.& Also SyedZada Bro
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks Rashed
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[NAME-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks Rashed.& Also SyedZada Bro
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks Rashed & Also SyedZada Bro
...
#Thanks RASHED & Also SyedZada Bro
